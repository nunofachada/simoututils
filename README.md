...
function performs pair-wise comparisons of multiple model implementations and
...
behavior (JEXNS and JEXDIFF), as discussed in reference [\[3\]][ref3]. The
...
stats_compare_table({'p', 'np', 'p', 'np', 'p', 'p'}, 0.000001, 0, cmp1, cmp2, cmp3)
```
...
In Table 8 of reference [\[2\]][ref2], ten comparisons are performed. Each
...
% Output comparison table
stats_compare_table('np', 1e-6, 1, cmp1, cmp2, cmp3, cmp4, cmp5, cmp6, cmp7, cmp8, cmp9, cmp10)
```
